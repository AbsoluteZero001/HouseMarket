...
VALUES (1, '望京SOHO精装两居室', '平层', '朝阳区', 2, 1, 89.00, 6500.00, '南北', '16/28层', '精装', '押一付三',
        ...
        '["/uploads/img.png","/uploads/img_1.png","/uploads/img_2.png"]', 2, 'NORMAL', 128, '2026-06-15 10:30:00'),
       (2, '中关村软件园精品LOFT公寓', '跃层', '海淀区', 2, 2, 120.00, 8800.00, '南北', '9/15层', '精装', '押一付三',
        ...
        '["/uploads/img_1.png","/uploads/img_2.png","/uploads/img.png"]', 2, 'NORMAL', 96, '2026-06-20 14:00:00'),
       (3, '金融街高端一居室', '平层', '西城区', 1, 1, 55.00, 7200.00, '南', '20/32层', '精装', '押一付三',
        ...
        '["/uploads/img_2.png","/uploads/img_3.png","/uploads/img_4.png"]', 3, 'NORMAL', 75, '2026-06-22 09:15:00'),
       (4, '三里屯时尚复式公寓', '复式', '朝阳区', 3, 2, 150.00, 15000.00, '东南', '顶层/21层', '豪华装修', '押二付一',
        ...
        '["/uploads/img_3.png","/uploads/img_4.png","/uploads/img_5.png"]', 3, 'NORMAL', 210, '2026-07-01 11:00:00'),
       (5, '总部基地精装三居室', '平层', '丰台区', 3, 2, 110.00, 5200.00, '南北', '6/18层', '精装', '押一付三',
        ...
        '["/uploads/img_4.png","/uploads/img_5.png","/uploads/img.png"]', 4, 'NORMAL', 64, '2026-07-05 16:30:00'),
       (6, '通州万达广场舒适两居室', '错层', '通州区', 2, 1, 95.00, 3800.00, '南', '12/24层', '简装', '押一付一',
        ...
        '["/uploads/img_5.png","/uploads/img.png","/uploads/img_1.png"]', 4, 'NORMAL', 88, '2026-07-08 08:45:00'),
       (7, '鼓楼大街四合院改造公寓', '平层', '东城区', 2, 1, 65.00, 9800.00, '南北', '1/3层', '精装', '押一付三',
        ...
        '["/uploads/img.png","/uploads/img_3.png","/uploads/img_5.png"]', 2, 'NORMAL', 152, '2026-07-10 13:20:00'),
       (8, '国贸CBD精装一居室', '平层', '朝阳区', 1, 1, 48.00, 5500.00, '北', '18/30层', '精装', '押一付三',
        ...
        '["/uploads/img_1.png","/uploads/img_2.png","/uploads/img_4.png"]', 3, 'NORMAL', 71, '2026-07-12 10:00:00'),
       (9, '五道口华清嘉园两居室', '平层', '海淀区', 2, 1, 78.00, 7500.00, '南北', '4/20层', '精装', '押一付三',
        ...
        '["/uploads/img_2.png","/uploads/img_4.png","/uploads/img.png"]', 4, 'NORMAL', 83, '2026-07-15 15:00:00'),
       (10, '亦庄开发区现代三居室', '复式', '大兴区', 3, 2, 135.00, 4500.00, '南北', '15/26层', '简装', '押一付三',
        ...
        '["/uploads/img_3.png","/uploads/img_1.png","/uploads/img_5.png"]', 2, 'NORMAL', 104, '2026-07-18 09:30:00');
